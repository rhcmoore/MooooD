...
$(document).ready(function() {
    ...
    //     newImageUL.append(newimageAngerLI, newimageFearLI, newimageJoyLI, newimageSadnessLI, newimageSurpriseLI);
    //     newDiv.append(newImage, newPost, newTextUL, newImageUL);
